...
/**
 * Write a description of class MyWorldMoveWithActor here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class MyWorldMoveWithActor extends World
{
    ...
    /**
     * Constructor for objects of class MyWorldMoveWithActor.
     * 
     */
    public MyWorldMoveWithActor()
    {    
        // Create a new world with 600x400 cells with a cell size of 1x1 pixels.
        //2771 X 980
        //1000 x 780
        super(1300, 650, 1); 
        addObject(new Frog(), 50, 500);
    }
