...
public class MarioAlberto extends Actor
{
    ...
    public void act() 
    {
        ...
        if(Greenfoot.isKeyDown("left")){setImage("MarioS2.png"); setLocation(getX()-4 ,getY());
        if (hitPipe()==true){setLocation(getX()+4,getY());}}
        if(Greenfoot.isKeyDown("right")){setImage("MarioS1.png"); setLocation(getX()+4 ,getY());}
